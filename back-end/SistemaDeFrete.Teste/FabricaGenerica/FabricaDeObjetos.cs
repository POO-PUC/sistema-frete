...
namespace Testes.FabricaGenerica
{
    public static class FabricaDeObjetos
    {
        ...
        public static Cidade FabricaCidade()
        {
        ...
        public static Cliente FabricaCliente()
        {
        ...
        public static Estado FabricaEstado()
        {
        ...
        public static Frete FabricaFrete()
        {
            var frete = new Frete
            {
                Codigo = 1,
        ...
        public static Funcionario FabricaFuncionario()
        {
        ...
        public static PessoaFisica FabricaPessoaFisica()
        {
        ...
        public static PessoaJuridica FabricaPessoaJuridica()
        {
